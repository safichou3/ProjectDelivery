 ...
 */
final class Version20250819232846 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE favorite_dish (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, dish_id INT NOT NULL, INDEX IDX_7B7B9587A76ED395 (user_id), INDEX IDX_7B7B9587148EB0CB (dish_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE favorite_dish');
    }
}
